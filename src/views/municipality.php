        ...
        <main>
            <div class="container-fluid px-4">
                <div class="container-fluid d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mt-4">Manage Municipality</h1>
                    ...
                    <div>
                        <button data-bs-target="#modalCreateMunicipality" data-bs-toggle="modal" class="btn btn-primary">Create New Municipality</button>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <?php
                             ...
                             \controllers\municipalityController::showAll();
                            ?>
                            </tbody>
                        </table>
                    </div>
...
<form class="modal fade" id="modalCreateMunicipality" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5 text-light" id="staticBackdropLabel">Municipality Details</h1>
            ...
            <div class="modal-body">
                <div class="form-floating mb-3">
                    ...
                    <div id="Municipality_msg" class="invalid-feedback"></div>
                </div>
...
<script src="../JQUERY/municipality.js"></script>
</body>
</html>
