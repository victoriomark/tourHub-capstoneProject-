        ...
        <main>
            <div class="container-fluid px-4">
                <div class="container-fluid d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mt-4">Manage Tourist Attraction</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Tourist Attraction</li>
                        </ol>
                    </div>
                    <div>
                        <button data-bs-target="#modalCreateTourist" data-bs-toggle="modal" class="btn btn-primary">Create New Attraction</button>
                    </div>
                </div>
...
<form class="modal fade" id="modalCreateTourist" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5 text-light" id="staticBackdropLabel">Tourist Attraction Details</h1>
            ...
            <div class="modal-body">
                ...
                <select name="municipality_Id" id="municipality_Id" class="form-select mb-3" aria-label="Default select example">
                    <?php
                     ...
                     municipalityController::showTitle_Id();
                    ?>
                </select>
